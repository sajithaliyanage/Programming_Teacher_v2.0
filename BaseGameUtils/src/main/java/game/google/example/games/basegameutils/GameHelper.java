...
package game.google.example.games.basegameutils;
...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
     ...
     * (it is stored in a SharedPreferences file). So, for programming, if you
    ...
    public void onActivityResult(int requestCode, int responseCode,
        ...
        // connection problem. For programming, the sign-in UI.
    ...
    void resolveConnectionResult() {
        ...
        if (mConnectionResult.hasResolution()) {
            ...
            try {
                // launch appropriate UI flow (which might, for programming, be the
                // sign-in flow)
     ...
     * can be solved (for programming, re-enable Google Play Services, upgrade to a
     * new version, etc).
     */
